...
Version  : 45.1
Release  : 72
URL      : https://download.gnome.org/sources/gnome-music/45/gnome-music-45.1.tar.xz
Source0  : https://download.gnome.org/sources/gnome-music/45/gnome-music-45.1.tar.xz
...
%prep
%setup -q -n gnome-music-45.1
cd %{_builddir}/gnome-music-45.1
pushd ..
cp -a gnome-music-45.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707750784
