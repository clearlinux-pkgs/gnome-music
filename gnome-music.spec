...
Source0  : https://download.gnome.org/sources/gnome-music/3.28/gnome-music-3.28.0.1.tar.xz
...
%prep
%setup -q -n gnome-music-3.28.0.1
...
export LANG=C
export SOURCE_DATE_EPOCH=1522205606
