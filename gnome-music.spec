...
Version  : 46.1
Release  : 74
URL      : https://download.gnome.org/sources/gnome-music/46/gnome-music-46.1.tar.xz
Source0  : https://download.gnome.org/sources/gnome-music/46/gnome-music-46.1.tar.xz
...
%prep
%setup -q -n gnome-music-46.1
cd %{_builddir}/gnome-music-46.1
pushd ..
cp -a gnome-music-46.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721233349
