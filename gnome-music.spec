...
Version  : 3.34.2
Release  : 31
URL      : https://download.gnome.org/sources/gnome-music/3.34/gnome-music-3.34.2.tar.xz
Source0  : https://download.gnome.org/sources/gnome-music/3.34/gnome-music-3.34.2.tar.xz
...
%prep
%setup -q -n gnome-music-3.34.2
cd %{_builddir}/gnome-music-3.34.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1576618696
...
cp %{_builddir}/gnome-music-3.34.2/LICENSE %{buildroot}/usr/share/package-licenses/gnome-music/9c5c5b98b412c4716f04530b90c221a11d5ba18a
