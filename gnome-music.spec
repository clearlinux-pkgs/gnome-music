...
Version  : 3.34.3
Release  : 32
URL      : https://download.gnome.org/sources/gnome-music/3.34/gnome-music-3.34.3.tar.xz
Source0  : https://download.gnome.org/sources/gnome-music/3.34/gnome-music-3.34.3.tar.xz
...
%prep
%setup -q -n gnome-music-3.34.3
cd %{_builddir}/gnome-music-3.34.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1578419184
...
cp %{_builddir}/gnome-music-3.34.3/LICENSE %{buildroot}/usr/share/package-licenses/gnome-music/9c5c5b98b412c4716f04530b90c221a11d5ba18a
