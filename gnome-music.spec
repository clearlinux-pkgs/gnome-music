...
Source0  : https://download.gnome.org/sources/gnome-music/3.38/gnome-music-3.38.1.tar.xz
...
%prep
%setup -q -n gnome-music-3.38.1
cd %{_builddir}/gnome-music-3.38.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1601935608
...
cp %{_builddir}/gnome-music-3.38.1/LICENSE %{buildroot}/usr/share/package-licenses/gnome-music/9c5c5b98b412c4716f04530b90c221a11d5ba18a
