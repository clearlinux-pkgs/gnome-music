...
Source0  : https://download.gnome.org/sources/gnome-music/47/gnome-music-47.1.tar.xz
...
%prep
%setup -q -n gnome-music-47.1
cd %{_builddir}/gnome-music-47.1
pushd ..
cp -a gnome-music-47.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1732555431
