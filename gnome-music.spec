...
Version  : 45.0
Release  : 71
URL      : https://download.gnome.org/sources/gnome-music/45/gnome-music-45.0.tar.xz
Source0  : https://download.gnome.org/sources/gnome-music/45/gnome-music-45.0.tar.xz
...
%prep
%setup -q -n gnome-music-45.0
cd %{_builddir}/gnome-music-45.0
pushd ..
cp -a gnome-music-45.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1697578133
