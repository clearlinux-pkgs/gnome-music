...
Source0  : https://download.gnome.org/sources/gnome-music/48/gnome-music-48.0.tar.xz
...
%prep
%setup -q -n gnome-music-48.0
cd %{_builddir}/gnome-music-48.0
pushd ..
cp -a gnome-music-48.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1746203841
...
/usr/share/metainfo/org.gnome.Music.metainfo.xml
